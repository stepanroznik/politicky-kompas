<template>
    <div class="">
        ...
        <div class="answers flex flex-col sm:max-w-2xl m-auto"
            :key="currentQuestionIndex">
            <button class="border-2 border-solid active:outline-none bg-green-400 text-white hover:bg-green-500 active:bg-green-600 font-semibold uppercase text-sm px-6 py-1 sm:py-3 rounded mb-1 ease-linear transition-all duration-150"
            ...
            <button class="border-2 border-solid active:outline-none bg-lime-400 text-white hover:bg-lime-500 active:bg-lime-600 font-semibold uppercase text-sm px-6 py-1 sm:py-3 rounded mb-1 ease-linear transition-all duration-150"
            ...
            <button class="border-2 border-solid active:outline-none bg-blueGray-400 text-white hover:bg-blueGray-500 active:bg-blueGray-600 font-semibold uppercase text-sm px-6 py-1 sm:py-3 rounded mb-1 ease-linear transition-all duration-150"
            ...
            <button class="border-2 border-solid active:outline-none bg-amber-400 text-white hover:bg-amber-500 active:bg-amber-600 font-semibold uppercase text-sm px-6 py-1 sm:py-3 rounded mb-1 ease-linear transition-all duration-150"
            ...
            <button class="border-2 border-solid active:outline-none bg-rose-400 text-white hover:bg-rose-500 active:bg-rose-600 font-semibold uppercase text-sm px-6 py-1 sm:py-3 rounded mb-1 ease-linear transition-all duration-150"
        ...
        <div class="py-4 sm:mt-4">
            <div class="xs:p-2 grid grid-cols-3 sm:max-w-2xl mx-auto"
            :key="currentQuestionIndex">
                <span class="text-sm text-gray-300">
                    <button class="p-1 border border-transparent active:outline-none rounded" :class="{'hover:border-gray-400 text-gray-600': !isCurrentQuestionFirst}"
                ...
                <span class="text-sm text-gray-300">
                    <button class="p-1 border border-transparent active:outline-none rounded" :class="{'hover:border-gray-400 text-gray-600': isCurrentQuestionAnswered && !isCurrentQuestionLast}"
            ...
            <div class="w-full rounded h-6 p-1 border border-gray-300">
                <div class="progress-bar rounded-sm h-full bg-gray-300"
